...
function SurveyStorage(dbQueryAdapter) {
    ...
    return {
      ...
      getPagedResults: function(postId, offset, limit, filter, sort, callback) {
        dbQueryAdapter.getObjectsExt("results",  [{ name: "postid", op: "=", value: postId }].concat(filter), sort, offset, limit, function(results) {
